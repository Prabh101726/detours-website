...
<p><strong>Last updated: September 13, 2026</strong></p>
...
<ul>
  ...
  <li><em>Crash, Diagnostic, and Performance Data.</em> We automatically collect crash reports, diagnostic information (device model, operating system version, technical stack traces), and performance timings (screen-to-screen navigation and request duration to our servers) to keep the app stable and working. This data is used only for App Functionality. It is not linked to your identity, is not used for tracking or advertising, and personal identifiers such as phone numbers and tenant IDs are removed before reports are sent.</li>
</ul>
...
<ul>
  ...
  <li><strong>Functional Software, Inc. (Sentry).</strong> We use Sentry for crash reporting and performance timing in the mobile app (how long screens and server requests take). Reports contain technical diagnostic and timing information only; they are not linked to your identity, are not used for tracking or advertising, and personal identifiers are scrubbed before transmission. See their privacy policy at <a href="https://sentry.io/privacy/" target="_blank">https://sentry.io/privacy/</a>.</li>
</ul>
    ...
    <div className="max-w-3xl mx-auto px-8 lg:px-12 pt-10 pb-28">
      <div className="mb-12 pt-1">
        ...
        <p style={{ color: "#64748b", fontSize: 14 }}>
          Last updated: September 13, 2026 &middot; Governing law: Ontario, Canada (PIPEDA)
        </p>
      </div>
