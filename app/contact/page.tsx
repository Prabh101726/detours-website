...
// ⚠️  Replace XXXXXXXXXX with your real WhatsApp number (digits only, no spaces/dashes)
const WHATSAPP_NUMBER = "1XXXXXXXXXX";

export default function ContactPage() {
  return (
    <div className="max-w-xl mx-auto px-8 pt-20 pb-28">
      ...
      <AnimatedSection className="mb-8">
        <a
          ...
          className="flex items-center justify-center gap-3 w-full bg-whatsapp/10 border border-whatsapp/25 text-whatsapp font-bold px-6 py-4 rounded-xl hover:bg-whatsapp/20 transition-colors text-base"
        >
